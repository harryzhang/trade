...
<div class="main">
    <div class="tanceng cent_a" style="top: 285px;display:block">
        <ul>
        	<a href="javascript:;" onclick="javascript:window.location.href=&#39;<c:url value='/redPack/personalCenter.html'/>&#39;"><img src="<c:url  value='/res-kuangji/images/success.png' />">
...
<script type="text/javascript">
	var t=setTimeout("window.location.href='<c:url value='/redPack/personalCenter.html'/>'", 15000);
</script>
</html>
