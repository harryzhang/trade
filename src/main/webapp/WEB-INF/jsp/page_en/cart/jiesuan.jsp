...
<div class="main">    
    ...
    <div class="order">
        <div class="odtop">
            ...
            -->
            <li> </li>
            <dd class="edit" style="width:30%;font-size:1.8rem" >Modify number</dd>			
        </div>
...
<div class="notice" style="top: 373.2px;">Delete</div>
<div class="total">
    <div class="all">
        <input name="a" type="checkbox">
        <label for="a">Check all</label>
    </div>
    <div class="tprice">
        <dd class="heji">Total：<span id="totalAmount">0</span></dd>
        <!--<dd class="freight">不含运费</dd>
        <dd id="totalRes" class="freight"></dd>
        -->
    </div>
    <input class="jsbtn" type="button" value="Submit" onclick="cart()">
</div>
