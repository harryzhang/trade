...
<c:if test="${platform ne 'android' && platform ne 'ios' && platform ne 'pad'}">
	...
	<div class="menu-group personal-ico">
       <%--  <a href="<c:url value ='/barcode/toMybarcode.html' />" class="item">
            <i class="icon icon-no1"></i>
            <p class="text">我的推荐二维码</p>
        </a>
         --%>
       <%--  <a href="<c:url value ='/wallet/listSk.html' />" class="item">
        ...
        <!-- 
        <a href="<c:url value ='/myWealth/payConfirmList' />" class="item">
            <i class="icon icon-no3"></i>
            <p class="text">付款确认</p>
        </a>
        <a href="<c:url value ='/myWealth/receiveConfirmList' />" class="item">
            <i class="icon icon-no3"></i>
            <p class="text">收款确认</p>
        </a>
   ...
   <div class="menu-group personal-ico">
		 ...
		 <a href="<c:url value ='/groupManager/addGroup.html' />" class="item">
            <i class="icon icon-no1"></i>
            <p class="text">增加团队</p>
        </a>
		
		<a href="<c:url value ='/groupManager/addGroupUser.html' />" class="item">
              <i class="icon icon-no1"></i> 
             <p class="text">添加团队成员</p>
        </a> 
		
   		<a  href='<c:url value="/kefu/listGroup.html"/>' class="item">
     ...
     <%--     <a  href='<c:url value="/upgrade/viewLowerUserInfo.html?netWork=A"/>' class="item">
        ...
        <a href="<c:url value="/param/toFxKefu.html"/>" class="item">
            <i class="icon icon-no6"></i>
            <p class="text">设置客服人员</p>
        </a>
        <a href="<c:url value ='/param/payMoney.html' />" class="item">
            <i class="icon icon-no2"></i>
            <p class="text">设置入费金额</p>
        </a>
        <a href="<c:url value ='/param/expirationTime.html' />" class="item">
            <i class="icon icon-no5"></i>
            <p class="text">设置会员超时时间</p>
        </a>
        <a href="<c:url value ='/param/fxAccount.html' />" class="item">
            <i class="icon icon-no7"></i>
            <p class="text">设置平台付款账号</p>
        </a>
        <%--
        <a href="<c:url value ='/recharge/viewWithdraw.do' />" class="item">
            <i class="icon icon-no8"></i>
            <p class="text">提现</p>
        </a>
        <a href="<c:url value="/loanPersonalCenter/toLloanQueryContract.do"/>"  class="item">
            <i class="icon icon-no9"></i>
            <p class="text">协议/合同</p>
        </a>
         --%>
    </div>
