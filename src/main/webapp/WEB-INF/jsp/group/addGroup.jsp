...
<head>
	...
	$(function(){
			$("#regBtn").bind("click",function(){
				...
				**/
				var param ={groupName:groupName,mobile:mobile,name:name};
				$.post('<c:url value="/groupManager/saveGroup.html"/>', param, function(data) {
	...
	<div class="wrap">
		...
		<div class="content manager nopad">
			<div class="manager-inn">
				...
				<div class="ipt">
					<span>顶级人员手机号码：</span><input type="number" name="mobile" id="mobile" >
				
				</div>
				<div class="ipt">
					<span>顶级人员姓名：</span><input type="text" name="name" id="name" >
