...
<body>
	...
	<div class="top-nav">
      ...
      <h2>设置平台账号</h2>
		...
		<div class="exit-wrap">
			<div class="item">
					<i style="display: block;  height: 20px;  -webkit-background-size: 140px auto;  background-size: 140px auto;    margin-right: 5px;">联系人：</i><input type="text" name="fxName" id="fxName" placeholder="平台联系人" value="${fxName}">
			</div>
			<div class="item">
					<i style="display: block;  height: 20px;  -webkit-background-size: 140px auto;  background-size: 140px auto;    margin-right: 5px;">手机号码：</i><input type="text" name="fxPhone" id="fxPhone" placeholder="联系手机号码"  value="${fxPhone}">
			</div>
			<div class="item">
					<i style="display: block;  height: 20px;  -webkit-background-size: 140px auto;  background-size: 140px auto;    margin-right: 5px;">支付宝：</i><input type="text" name="fxZfb" id="fxZfb" placeholder="请输入支付宝" value="${fxZfb}">
			</div>
			<div class="item">
					<i style="display: block;  height: 20px;  -webkit-background-size: 140px auto;  background-size: 140px auto;    margin-right: 5px;">微信：</i><input type="text" name="fxWeixin" id="fxWeixin" placeholder="请输入微信"  value="${fxWeixin}">
	...
	$(function(){
		$("#regBtn").bind("click",function(){
			...
			$.post('<c:url value="/param/setFxAccount.html"/>', param, function(data) {
