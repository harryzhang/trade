...
<BODY>
	...
	<div class="box">
		<ul id="boxul">
			...
			<li><label id="user_money">当前退本证券：${amount} 欧 </label></li>
	</div>
	</ul>
	<input class="txbut" value="退本" type="button">
	</div>
	...
	<script>
        ...
        $('.txbut').on('click', function () {
	        ...
	        $.ajax({
		       		    type: 'post',
		                url: "<c:url value='/member/unPay.html'/>",
		                data: {bankName:bankName,passwordTwo:passwordTwo,
		                	      bankNo:bank_no,bankUser:bank_user},
		                dataType: 'json',
