        ...
        touchmove: function(e) {
            ...
            if (_advancedSupport && e.touches && e.touches.length >= 2) {
                ...
                if (_zoom < 1) {
                    ...
                    _zoomXY = [0, 0];
                    $(img).css({
                        "-webkit-transitionDuration": "200ms",
                ...
                $(img).css({
                    "-webkit-transform": "scale(" + _zoom + ") translate(" + _zoomXY[0] + "px," + _zoomXY[1] + "px)",
                    "transform": "scale(" + _zoom + ") translate(" + _zoomXY[0] + "px," + _zoomXY[1] + "px)"
                });
                return
            }
            if (isDoubleZoom) {
            ...
            if (_zoom != 1) {
                ...
                $(img).css({
                    "-webkit-transform": "scale(" + _zoom + ") translate(" + _zoomXY[0] +
                        "px," + _zoomXY[1] + "px)",
                    "transform": "scale(" + _zoom + ") translate(" + _zoomXY[0] +
                        "px," + _zoomXY[1] + "px)"
                })
            } else {
                if (!isSlide) return;
                ...
                _this.find(".pv-inner").css({
                    "-webkit-transform": "translate(" + _transX + "px,0px) translateZ(0)"
                });
        ...
        touchend: function(e) {
            ...
            if (_zoom != 1) {
                ...
                if (Math.abs(_zoomXY[0]) < 10) {
                    $(img).css({
                        "-webkit-transform": "scale(" + _zoom + ") translate(0px," + _zoomXY[1] + "px)",
                        "transform": "scale(" + _zoom + ") translate(0px," + _zoomXY[1] + "px)"
                    });
                    return
                } else {
                    $(img).css({
