	...
	<div class="wrap">
		<header class="header">
			...
			<div class="search flex">
				...
				<div class="search-input"><input id="userName" name ="userName" type="text" placeholder="请输入需删号手机号码"></div>
		...
		<c:if test="${!empty userList}">
			...
			<div class="item flex">
				...
				<c:if test="${userDo.status==2}">
					<div class="btn" ><a href="#" class="subbtn" id="subbtn${userDo.id}" cdataid="${userDo.id }" >删号</a></div>
				</c:if>
...
<script type="text/javascript">
    ...
    function submitConfirm(userId){
    	...
    	$.post('<c:url value="/kefu/doDeleteUser.html"/>', param, function(data) {
	...
	function search(){
			...
			var url ='<c:url value="/kefu/deleteUser?userName="/>' + userName ;
