...
<div class="main"> 
   <div style="margin:0;width:100%">
       <div style="text-align: center; margin: auto;  padding-top: 20px;  padding-bottom: 10px; border-bottom: thin dashed black; font-size: 18px;"><span style="margin-right:20px">
       		${noticeContent}
       	</div>
   </div>
</div>
