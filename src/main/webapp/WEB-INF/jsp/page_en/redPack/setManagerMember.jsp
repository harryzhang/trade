...
<body class="bg-2"  style="padding-bottom:60px;" >
	...
	<section class="sign-area">
		<form action="${loginServerUrl }/upgrade/saveManagerMember.html" id="regForm" method="post">
			
			<div class="sign-style br-2">
				<span class="sign-lable" style="color: #894c8d;">管理员手机号码</span>
	...
	<script>
		$(function(){
			...
			$("#regBtn").bind("click",function(){
				...
				var options = {type:"POST",url:"${loginServerUrl }/upgrade/saveManagerMember.html",data:{mobilePhone:mobilePhone,pwd:pwd}};
				ajaxRequest(options,function(data){
					if(data.result=='设置管理员成功'){
